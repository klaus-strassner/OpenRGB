...
#ifndef PB_ZMK_BEHAVIORS_BEHAVIORS_PB_H_INCLUDED
#define PB_ZMK_BEHAVIORS_BEHAVIORS_PB_H_INCLUDED
#include <pb.h>
...
typedef struct _zmk_behaviors_GetAnalogBehaviorDetailsRequest {
    uint32_t analog_behavior_id;
} zmk_behaviors_GetAnalogBehaviorDetailsRequest;
...
typedef struct _zmk_behaviors_Request {
    ...
    union {
        ...
        zmk_behaviors_GetAnalogBehaviorDetailsRequest get_analog_behavior_details;
    } request_type;
} zmk_behaviors_Request;

typedef struct _zmk_behaviors_ListAllBehaviorsResponse {
    pb_callback_t behaviors;
    pb_callback_t analog_behaviors;
...
typedef struct _zmk_behaviors_GetAnalogBehaviorDetailsResponse {
    uint32_t id;
    pb_callback_t display_name;
    pb_callback_t metadata;
} zmk_behaviors_GetAnalogBehaviorDetailsResponse;
...
typedef struct _zmk_behaviors_Response {
    ...
    union {
        ...
        zmk_behaviors_GetAnalogBehaviorDetailsResponse get_analog_behavior_details;
    } response_type;
} zmk_behaviors_Response;

typedef struct _zmk_behaviors_AnalogBehaviorBindingParametersSet {
    pb_callback_t param0;
    pb_callback_t param1;
    pb_callback_t param2;
    pb_callback_t param3;
} zmk_behaviors_AnalogBehaviorBindingParametersSet;

typedef struct _zmk_behaviors_AnalogBehaviorParameterValueCalibratedRange {
    int32_t min;
    int32_t max;
} zmk_behaviors_AnalogBehaviorParameterValueCalibratedRange;

typedef struct _zmk_behaviors_AnalogBehaviorParameterNil {
    char dummy_field;
} zmk_behaviors_AnalogBehaviorParameterNil;

typedef struct _zmk_behaviors_AnalogBehaviorParameterValueDescription {
    pb_callback_t name;
    pb_size_t which_value_type;
    union {
        zmk_behaviors_AnalogBehaviorParameterNil nil;
        /* uint32 constant = 3; // RFU */
        zmk_behaviors_AnalogBehaviorParameterValueCalibratedRange range;
    } value_type;
} zmk_behaviors_AnalogBehaviorParameterValueDescription;
...
#define zmk_behaviors_GetAnalogBehaviorDetailsRequest_init_default {0}
#define zmk_behaviors_Response_init_default      {0, {zmk_behaviors_ListAllBehaviorsResponse_init_default}}
#define zmk_behaviors_ListAllBehaviorsResponse_init_default {{{NULL}, NULL}, {{NULL}, NULL}}
...
#define zmk_behaviors_GetAnalogBehaviorDetailsResponse_init_default {0, {{NULL}, NULL}, {{NULL}, NULL}}
#define zmk_behaviors_AnalogBehaviorBindingParametersSet_init_default {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define zmk_behaviors_AnalogBehaviorParameterValueCalibratedRange_init_default {0, 0}
#define zmk_behaviors_AnalogBehaviorParameterNil_init_default {0}
#define zmk_behaviors_AnalogBehaviorParameterValueDescription_init_default {{{NULL}, NULL}, 0, {zmk_behaviors_AnalogBehaviorParameterNil_init_default}}
#define zmk_behaviors_Request_init_zero          {0, {0}}
#define zmk_behaviors_GetBehaviorDetailsRequest_init_zero {0}
#define zmk_behaviors_GetAnalogBehaviorDetailsRequest_init_zero {0}
#define zmk_behaviors_Response_init_zero         {0, {zmk_behaviors_ListAllBehaviorsResponse_init_zero}}
#define zmk_behaviors_ListAllBehaviorsResponse_init_zero {{{NULL}, NULL}, {{NULL}, NULL}}
...
#define zmk_behaviors_GetAnalogBehaviorDetailsResponse_init_zero {0, {{NULL}, NULL}, {{NULL}, NULL}}
#define zmk_behaviors_AnalogBehaviorBindingParametersSet_init_zero {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define zmk_behaviors_AnalogBehaviorParameterValueCalibratedRange_init_zero {0, 0}
#define zmk_behaviors_AnalogBehaviorParameterNil_init_zero {0}
#define zmk_behaviors_AnalogBehaviorParameterValueDescription_init_zero {{{NULL}, NULL}, 0, {zmk_behaviors_AnalogBehaviorParameterNil_init_zero}}

/* Field tags (for use in manual encoding/decoding) */
#define zmk_behaviors_GetBehaviorDetailsRequest_behavior_id_tag 1
#define zmk_behaviors_GetAnalogBehaviorDetailsRequest_analog_behavior_id_tag 1
#define zmk_behaviors_Request_list_all_behaviors_tag 1
#define zmk_behaviors_Request_get_behavior_details_tag 2
#define zmk_behaviors_Request_get_analog_behavior_details_tag 64
#define zmk_behaviors_ListAllBehaviorsResponse_behaviors_tag 1
#define zmk_behaviors_ListAllBehaviorsResponse_analog_behaviors_tag 64
...
#define zmk_behaviors_GetAnalogBehaviorDetailsResponse_id_tag 1
#define zmk_behaviors_GetAnalogBehaviorDetailsResponse_display_name_tag 2
#define zmk_behaviors_GetAnalogBehaviorDetailsResponse_metadata_tag 3
#define zmk_behaviors_Response_list_all_behaviors_tag 1
#define zmk_behaviors_Response_get_behavior_details_tag 2
#define zmk_behaviors_Response_get_analog_behavior_details_tag 64
#define zmk_behaviors_AnalogBehaviorBindingParametersSet_param0_tag 1
#define zmk_behaviors_AnalogBehaviorBindingParametersSet_param1_tag 2
#define zmk_behaviors_AnalogBehaviorBindingParametersSet_param2_tag 3
#define zmk_behaviors_AnalogBehaviorBindingParametersSet_param3_tag 4
#define zmk_behaviors_AnalogBehaviorParameterValueCalibratedRange_min_tag 1
#define zmk_behaviors_AnalogBehaviorParameterValueCalibratedRange_max_tag 2
#define zmk_behaviors_AnalogBehaviorParameterValueDescription_name_tag 1
#define zmk_behaviors_AnalogBehaviorParameterValueDescription_nil_tag 2
#define zmk_behaviors_AnalogBehaviorParameterValueDescription_range_tag 4
...
X(a, STATIC,   ONEOF,    MESSAGE,  (request_type,get_analog_behavior_details,request_type.get_analog_behavior_details),  64)
...
#define zmk_behaviors_Request_request_type_get_analog_behavior_details_MSGTYPE zmk_behaviors_GetAnalogBehaviorDetailsRequest
...
#define zmk_behaviors_GetAnalogBehaviorDetailsRequest_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UINT32,   analog_behavior_id,   1)
#define zmk_behaviors_GetAnalogBehaviorDetailsRequest_CALLBACK NULL
#define zmk_behaviors_GetAnalogBehaviorDetailsRequest_DEFAULT NULL
...
X(a, STATIC,   ONEOF,    MESSAGE,  (response_type,get_analog_behavior_details,response_type.get_analog_behavior_details),  64)
...
#define zmk_behaviors_Response_response_type_get_analog_behavior_details_MSGTYPE zmk_behaviors_GetAnalogBehaviorDetailsResponse

#define zmk_behaviors_ListAllBehaviorsResponse_FIELDLIST(X, a) \
X(a, CALLBACK, REPEATED, UINT32,   behaviors,         1) \
X(a, CALLBACK, REPEATED, UINT32,   analog_behaviors,  64)
...
#define zmk_behaviors_GetAnalogBehaviorDetailsResponse_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UINT32,   id,                1) \
X(a, CALLBACK, SINGULAR, STRING,   display_name,      2) \
X(a, CALLBACK, REPEATED, MESSAGE,  metadata,          3)
#define zmk_behaviors_GetAnalogBehaviorDetailsResponse_CALLBACK pb_default_field_callback
#define zmk_behaviors_GetAnalogBehaviorDetailsResponse_DEFAULT NULL
#define zmk_behaviors_GetAnalogBehaviorDetailsResponse_metadata_MSGTYPE zmk_behaviors_AnalogBehaviorBindingParametersSet

#define zmk_behaviors_AnalogBehaviorBindingParametersSet_FIELDLIST(X, a) \
X(a, CALLBACK, REPEATED, MESSAGE,  param0,            1) \
X(a, CALLBACK, REPEATED, MESSAGE,  param1,            2) \
X(a, CALLBACK, REPEATED, MESSAGE,  param2,            3) \
X(a, CALLBACK, REPEATED, MESSAGE,  param3,            4)
#define zmk_behaviors_AnalogBehaviorBindingParametersSet_CALLBACK pb_default_field_callback
#define zmk_behaviors_AnalogBehaviorBindingParametersSet_DEFAULT NULL
#define zmk_behaviors_AnalogBehaviorBindingParametersSet_param0_MSGTYPE zmk_behaviors_AnalogBehaviorParameterValueDescription
#define zmk_behaviors_AnalogBehaviorBindingParametersSet_param1_MSGTYPE zmk_behaviors_AnalogBehaviorParameterValueDescription
#define zmk_behaviors_AnalogBehaviorBindingParametersSet_param2_MSGTYPE zmk_behaviors_AnalogBehaviorParameterValueDescription
#define zmk_behaviors_AnalogBehaviorBindingParametersSet_param3_MSGTYPE zmk_behaviors_AnalogBehaviorParameterValueDescription

#define zmk_behaviors_AnalogBehaviorParameterValueCalibratedRange_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, INT32,    min,               1) \
X(a, STATIC,   SINGULAR, INT32,    max,               2)
#define zmk_behaviors_AnalogBehaviorParameterValueCalibratedRange_CALLBACK NULL
#define zmk_behaviors_AnalogBehaviorParameterValueCalibratedRange_DEFAULT NULL

#define zmk_behaviors_AnalogBehaviorParameterNil_FIELDLIST(X, a) \

#define zmk_behaviors_AnalogBehaviorParameterNil_CALLBACK NULL
#define zmk_behaviors_AnalogBehaviorParameterNil_DEFAULT NULL

#define zmk_behaviors_AnalogBehaviorParameterValueDescription_FIELDLIST(X, a) \
X(a, CALLBACK, SINGULAR, STRING,   name,              1) \
X(a, STATIC,   ONEOF,    MESSAGE,  (value_type,nil,value_type.nil),   2) \
X(a, STATIC,   ONEOF,    MESSAGE,  (value_type,range,value_type.range),   4)
#define zmk_behaviors_AnalogBehaviorParameterValueDescription_CALLBACK pb_default_field_callback
#define zmk_behaviors_AnalogBehaviorParameterValueDescription_DEFAULT NULL
#define zmk_behaviors_AnalogBehaviorParameterValueDescription_value_type_nil_MSGTYPE zmk_behaviors_AnalogBehaviorParameterNil
#define zmk_behaviors_AnalogBehaviorParameterValueDescription_value_type_range_MSGTYPE zmk_behaviors_AnalogBehaviorParameterValueCalibratedRange

extern const pb_msgdesc_t zmk_behaviors_Request_msg;
extern const pb_msgdesc_t zmk_behaviors_GetBehaviorDetailsRequest_msg;
extern const pb_msgdesc_t zmk_behaviors_GetAnalogBehaviorDetailsRequest_msg;
...
extern const pb_msgdesc_t zmk_behaviors_GetAnalogBehaviorDetailsResponse_msg;
extern const pb_msgdesc_t zmk_behaviors_AnalogBehaviorBindingParametersSet_msg;
extern const pb_msgdesc_t zmk_behaviors_AnalogBehaviorParameterValueCalibratedRange_msg;
extern const pb_msgdesc_t zmk_behaviors_AnalogBehaviorParameterNil_msg;
extern const pb_msgdesc_t zmk_behaviors_AnalogBehaviorParameterValueDescription_msg;
...
#define zmk_behaviors_GetAnalogBehaviorDetailsRequest_fields &zmk_behaviors_GetAnalogBehaviorDetailsRequest_msg
...
#define zmk_behaviors_GetAnalogBehaviorDetailsResponse_fields &zmk_behaviors_GetAnalogBehaviorDetailsResponse_msg
#define zmk_behaviors_AnalogBehaviorBindingParametersSet_fields &zmk_behaviors_AnalogBehaviorBindingParametersSet_msg
#define zmk_behaviors_AnalogBehaviorParameterValueCalibratedRange_fields &zmk_behaviors_AnalogBehaviorParameterValueCalibratedRange_msg
#define zmk_behaviors_AnalogBehaviorParameterNil_fields &zmk_behaviors_AnalogBehaviorParameterNil_msg
#define zmk_behaviors_AnalogBehaviorParameterValueDescription_fields &zmk_behaviors_AnalogBehaviorParameterValueDescription_msg
...
/* zmk_behaviors_GetAnalogBehaviorDetailsResponse_size depends on runtime parameters */
/* zmk_behaviors_AnalogBehaviorBindingParametersSet_size depends on runtime parameters */
/* zmk_behaviors_AnalogBehaviorParameterValueDescription_size depends on runtime parameters */
#define ZMK_BEHAVIORS_BEHAVIORS_PB_H_MAX_SIZE    zmk_behaviors_BehaviorParameterValueDescriptionRange_size
#define zmk_behaviors_AnalogBehaviorParameterNil_size 0
#define zmk_behaviors_AnalogBehaviorParameterValueCalibratedRange_size 22
...
#define zmk_behaviors_GetAnalogBehaviorDetailsRequest_size 6
#define zmk_behaviors_GetBehaviorDetailsRequest_size 6
#define zmk_behaviors_Request_size               9
